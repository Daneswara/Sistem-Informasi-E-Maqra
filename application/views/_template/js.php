...
<!-- jQuery 2.1.3 -->
<!-- <script src="<?php echo base_url('asset/adminlte/bower_components/jQuery/jQuery-2.1.3.min.js') ?>"></script> -->
<!-- Bootstrap 3.3.2 JS -->
<!-- <script src="<?php echo base_url('asset/adminlte/bower_components/bootstrap/js/bootstrap.min.js') ?>" type="text/javascript"></script> -->
<!-- SlimScroll -->
<!-- <script src="<?php echo base_url('asset/adminlte/bower_components/slimScroll/jquery.slimScroll.min.js') ?>" type="text/javascript"></script> -->
<!-- FastClick -->
<script src='<?php echo base_url('asset/adminlte/bower_components/fastclick/fastclick.min.js') ?>'></script>
<!-- AdminLTE App -->
