...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <nav class="navbar navbar-static-top">
            ...
            <a href="<?php echo base_url(); ?>asset/adminlte/#" class="sidebar-toggle" data-toggle="push-menu"
               role="button">
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown messages-menu">
                        <a href="<?php echo base_url(); ?>asset/adminlte/#" class="dropdown-toggle"
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li>
                                ...
                                <ul class="menu">
                                    ...
                                    <li>
                                        <a href="<?php echo base_url(); ?>asset/adminlte/#">
                                            <div class="pull-left">
                                                <img src="<?php echo base_url(); ?>asset/adminlte/dist/img/user3-128x128.jpg"
                                                     class="img-circle" alt="User Image">
                                            </div>
                                            <h4>
                                    ...
                                    <li>
                                        <a href="<?php echo base_url(); ?>asset/adminlte/#">
                                            <div class="pull-left">
                                                <img src="<?php echo base_url(); ?>asset/adminlte/dist/img/user4-128x128.jpg"
                                                     class="img-circle" alt="User Image">
                                            </div>
                                            <h4>
                                                Developers
                            ...
                            <li class="footer"><a href="<?php echo base_url(); ?>asset/adminlte/#">See All Messages</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        <a href="<?php echo base_url(); ?>asset/adminlte/#" data-toggle="control-sidebar"><i
        ...
        <section class="sidebar">
            ...
            <div class="user-panel">
                <div class="pull-left image">
                    <img src="<?php echo base_url(); ?>asset/adminlte/dist/img/user2-160x160.jpg" class="img-circle"
                         alt="User Image">
                </div>
            ...
            <ul class="sidebar-menu" data-widget="tree">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li class="active"><a href="<?php echo base_url(); ?>asset/adminlte/index.html"><i
                                        class="fa fa-circle-o"></i> Dashboard v1</a></li>
                        <li><a href="<?php echo base_url(); ?>asset/adminlte/index2.html"><i class="fa fa-circle-o"></i>
                                Dashboard v2</a></li>
                    </ul>
                </li>
                <li class="treeview">
              ...
              <span class="label label-primary pull-right">4</span>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="<?php echo base_url(); ?>asset/adminlte/pages/layout/top-nav.html"><i
                                        class="fa fa-circle-o"></i> Top Navigation</a></li>
                        <li><a href="<?php echo base_url(); ?>asset/adminlte/pages/layout/boxed.html"><i
                                        class="fa fa-circle-o"></i> Boxed</a></li>
                        <li><a href="<?php echo base_url(); ?>asset/adminlte/pages/layout/fixed.html"><i
                                        class="fa fa-circle-o"></i> Fixed</a></li>
                        <li><a href="<?php echo base_url(); ?>asset/adminlte/pages/layout/collapsed-sidebar.html"><i
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="<?php echo base_url(); ?>asset/adminlte/pages/charts/chartjs.html"><i
                                        class="fa fa-circle-o"></i> ChartJS</a></li>
                        <li><a href="<?php echo base_url(); ?>asset/adminlte/pages/charts/morris.html"><i
                                        class="fa fa-circle-o"></i> Morris</a></li>
                        <li><a href="<?php echo base_url(); ?>asset/adminlte/pages/charts/flot.html"><i
                                        class="fa fa-circle-o"></i> Flot</a></li>
                        <li><a href="<?php echo base_url(); ?>asset/adminlte/pages/charts/inline.html"><i
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="<?php echo base_url(); ?>asset/adminlte/pages/UI/general.html"><i
                                        class="fa fa-circle-o"></i> General</a></li>
                        <li><a href="<?php echo base_url(); ?>asset/adminlte/pages/UI/icons.html"><i
                                        class="fa fa-circle-o"></i> Icons</a></li>
                        <li><a href="<?php echo base_url(); ?>asset/adminlte/pages/UI/buttons.html"><i
                                        class="fa fa-circle-o"></i> Buttons</a></li>
                        <li><a href="<?php echo base_url(); ?>asset/adminlte/pages/UI/sliders.html"><i
                                        class="fa fa-circle-o"></i> Sliders</a></li>
                        <li><a href="<?php echo base_url(); ?>asset/adminlte/pages/UI/timeline.html"><i
                                        class="fa fa-circle-o"></i> Timeline</a></li>
                        <li><a href="<?php echo base_url(); ?>asset/adminlte/pages/UI/modals.html"><i
            ...
            <div class="row">
                <div class="col-lg-3 col-xs-6">
                    ...
                    <div class="small-box bg-aqua">
                        ...
                        <a href="<?php echo base_url(); ?>asset/adminlte/#" class="small-box-footer">More info <i
                ...
                <section class="col-lg-7 connectedSortable">
                    ...
                    <div class="nav-tabs-custom">
                        ...
                        <ul class="nav nav-tabs pull-right">
                            <li class="active"><a href="<?php echo base_url(); ?>asset/adminlte/#revenue-chart"
                                                  data-toggle="tab">Area</a></li>
                            <li><a href="<?php echo base_url(); ?>asset/adminlte/#sales-chart"
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2014-2016 <a href="<?php echo base_url(); ?>asset/adminlte/https://adminlte.io">Almsaeed
    ...
    <aside class="control-sidebar control-sidebar-dark">
        ...
        <ul class="nav nav-tabs nav-justified control-sidebar-tabs">
            <li><a href="<?php echo base_url(); ?>asset/adminlte/#control-sidebar-home-tab" data-toggle="tab"><i
                            class="fa fa-home"></i></a></li>
            <li><a href="<?php echo base_url(); ?>asset/adminlte/#control-sidebar-settings-tab" data-toggle="tab"><i
