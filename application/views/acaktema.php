...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        <li><a href="<?php echo base_url('index.php/AcakTema') ?>"><i class="fa fa-arrow-circle-left"></i> Kembali</a></li>
...
<script>
    ...
    btn2.onclick = function() {
        ...
        if(pd == banyak_peserta_daerah){
            ...
            var linkupdateKategori = "<?php echo base_url(); ?>index.php/AcakTema/getPesertaDaerah/"+(pd+1)+"";
    ...
    stop.onclick = function() {
        ...
        $.ajax({
            type: 'POST',
            url: "<?php echo base_url(); ?>index.php/AcakTema/postTema",
            data: myKeyVals,
            dataType: "text",
        ...
        $.ajax({
            type: 'POST',
            url: "<?php echo base_url(); ?>index.php/AcakTema/updateTemaPeserta/"+splitPesertaDaerah[pd]+"",
            data: updateData,
            dataType: "text",
            success: function(data) {
                alert("Save Complete")
